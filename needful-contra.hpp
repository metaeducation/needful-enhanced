...
// good idea.  Just do:
//
//     #define NEEDFUL_INIT_CORRUPTS_LIKE_SINK  1  // Init() => actually Sink()
//
...
#if !defined(NEEDFUL_INIT_CORRUPTS_LIKE_SINK)
    #define NEEDFUL_INIT_CORRUPTS_LIKE_SINK  0
#endif

#if NEEDFUL_INIT_CORRUPTS_LIKE_SINK
    #undef NeedfulInit
